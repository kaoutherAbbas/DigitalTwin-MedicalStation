...
return ( <div className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow p-6 animate-fade-in">
  ...
  <div className="space-y-4">
    ...
    <button
      ...
      className="w-full mt-2 px-4 py-3 rounded-lg bg-slate-900 text-white font-medium hover:bg-slate-800 transition-colors"
    >
